...
import { GENERATED_API_ENDPOINTS } from './generated_APIRuntime.js';
    ...
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const STANDARD_TOUR_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"standard_tour","required":true,"wireName":"standard_tour"}, SHARED_FIELD_DEFS.FIELD_61)
        ]
      };
    ...
    schemaField({"name":"areas","required":false,"wireName":"areas"}, SHARED_FIELD_DEFS.FIELD_77),
    ...
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const DESTINATION_AREA_CREATE_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"area","required":true,"wireName":"area"}, SHARED_FIELD_DEFS.FIELD_82),
    schemaField({"name":"catalog","required":true,"wireName":"catalog"}, SHARED_FIELD_DEFS.FIELD_80)
        ]
      };
    ...
    schemaField({"name":"assigned_atp_staff","required":false,"wireName":"assigned_atp_staff"}, SHARED_FIELD_DEFS.FIELD_90),
    ...
    schemaField({"name":"notes","required":false,"wireName":"notes"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"persons","required":false,"wireName":"persons"}, SHARED_FIELD_DEFS.FIELD_91),
    schemaField({"name":"travel_plan","required":false,"wireName":"travel_plan"}, SHARED_FIELD_DEFS.FIELD_59),
    schemaField({"name":"web_form_submission","required":false,"wireName":"web_form_submission"}, SHARED_FIELD_DEFS.FIELD_92),
    schemaField({"name":"offer","required":true,"wireName":"offer"}, SHARED_FIELD_DEFS.FIELD_93),
    schemaField({"name":"travel_plan_pdfs","required":false,"wireName":"travel_plan_pdfs"}, SHARED_FIELD_DEFS.FIELD_94),
    schemaField({"name":"generated_offers","required":false,"wireName":"generated_offers"}, SHARED_FIELD_DEFS.FIELD_95),
    schemaField({"name":"travel_plan_translation_status","required":true,"wireName":"travel_plan_translation_status"}, SHARED_FIELD_DEFS.FIELD_96),
    ...
    schemaField({"name":"style","required":false,"wireName":"style"}, SHARED_FIELD_DEFS.FIELD_97),
    ...
    schemaField({"name":"value","required":true,"wireName":"value"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const BOOKING_TRAVEL_PLAN_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"destination_scope","required":false,"wireName":"destination_scope"}, SHARED_FIELD_DEFS.FIELD_98),
    schemaField({"name":"destinations","required":false,"wireName":"destinations"}, SHARED_FIELD_DEFS.FIELD_17),
    ...
    schemaField({"name":"staff_profile","required":false,"wireName":"staff_profile"}, SHARED_FIELD_DEFS.FIELD_90)
        ]
      };
    ...
    schemaField({"name":"title","required":false,"wireName":"title"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const TRAVEL_PLAN_DESTINATION_SCOPE_ENTRY_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"destination","required":true,"wireName":"destination"}, SHARED_FIELD_DEFS.FIELD_2),
    schemaField({"name":"areas","required":false,"wireName":"areas"}, SHARED_FIELD_DEFS.FIELD_114)
        ]
      };
    ...
    schemaField({"name":"title","required":false,"wireName":"title"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"overnight_location","required":false,"wireName":"overnight_location"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"services","required":false,"wireName":"services"}, SHARED_FIELD_DEFS.FIELD_118),
    schemaField({"name":"notes","required":false,"wireName":"notes"}, SHARED_FIELD_DEFS.FIELD_1)
        ]
      };
    ...
    schemaField({"name":"additional_items","required":false,"wireName":"additional_items"}, SHARED_FIELD_DEFS.FIELD_66)
      ...
      export const TRAVEL_PLAN_DESTINATION_AREA_SELECTION_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"area_id","required":true,"wireName":"area_id"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"places","required":false,"wireName":"places"}, SHARED_FIELD_DEFS.FIELD_122)
        ]
      };
