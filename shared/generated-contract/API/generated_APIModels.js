...
import { GENERATED_API_ENDPOINTS } from './generated_APIRuntime.js';
    ...
    schemaField({"name":"items","required":false,"wireName":"items"}, SHARED_FIELD_DEFS.FIELD_75)
      ...
      export const ATP_STAFF_PROFILE_UPDATE_REQUEST_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"languages","required":false,"wireName":"languages"}, SHARED_FIELD_DEFS.FIELD_76),
    schemaField({"name":"destinations","required":false,"wireName":"destinations"}, SHARED_FIELD_DEFS.FIELD_17),
    schemaField({"name":"name","required":false,"wireName":"name"}, SHARED_FIELD_DEFS.FIELD_1),
    ...
    schemaField({"name":"data_base64","required":true,"wireName":"data_base64"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const DESTINATION_SCOPE_CATALOG_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"destinations","required":false,"wireName":"destinations"}, SHARED_FIELD_DEFS.FIELD_77),
    schemaField({"name":"areas","required":false,"wireName":"areas"}, SHARED_FIELD_DEFS.FIELD_78),
    schemaField({"name":"places","required":false,"wireName":"places"}, SHARED_FIELD_DEFS.FIELD_79)
        ]
      };
    ...
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const DESTINATION_CREATE_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"destination","required":true,"wireName":"destination"}, SHARED_FIELD_DEFS.FIELD_80),
    schemaField({"name":"catalog","required":true,"wireName":"catalog"}, SHARED_FIELD_DEFS.FIELD_81)
        ]
      };
    ...
    schemaField({"name":"destination","required":true,"wireName":"destination"}, SHARED_FIELD_DEFS.FIELD_2),
    schemaField({"name":"name","required":true,"wireName":"name"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"name_i18n","required":false,"wireName":"name_i18n"}, SHARED_FIELD_DEFS.FIELD_82),
    ...
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const DESTINATION_AREA_CREATE_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"area","required":true,"wireName":"area"}, SHARED_FIELD_DEFS.FIELD_83),
    schemaField({"name":"catalog","required":true,"wireName":"catalog"}, SHARED_FIELD_DEFS.FIELD_81)
        ]
      };
    ...
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const DESTINATION_PLACE_CREATE_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"place","required":true,"wireName":"place"}, SHARED_FIELD_DEFS.FIELD_84),
    schemaField({"name":"catalog","required":true,"wireName":"catalog"}, SHARED_FIELD_DEFS.FIELD_81)
        ]
      };
    ...
    schemaField({"name":"travel_plan","required":false,"wireName":"travel_plan"}, SHARED_FIELD_DEFS.FIELD_86),
    schemaField({"name":"expected_updated_at","required":false,"wireName":"expected_updated_at"}, SHARED_FIELD_DEFS.FIELD_5)
      ...
      export const TOUR_RESPONSE_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"tour","required":true,"wireName":"tour"}, SHARED_FIELD_DEFS.FIELD_87)
        ]
      };
    ...
    schemaField({"name":"entries","required":false,"wireName":"entries"}, SHARED_FIELD_DEFS.FIELD_57)
      ...
      export const TOUR_TRAVEL_PLAN_UPDATE_REQUEST_SCHEMA = {
        ...
        requireOneOf: [],
        fields: [
    schemaField({"name":"travel_plan","required":true,"wireName":"travel_plan"}, SHARED_FIELD_DEFS.FIELD_86),
    schemaField({"name":"expected_updated_at","required":false,"wireName":"expected_updated_at"}, SHARED_FIELD_DEFS.FIELD_5),
    schemaField({"name":"actor","required":false,"wireName":"actor"}, SHARED_FIELD_DEFS.FIELD_1)
        ]
      };
    ...
    schemaField({"name":"service_kind","required":false,"wireName":"service_kind"}, SHARED_FIELD_DEFS.FIELD_102),
    ...
    schemaField({"name":"unit_amount_cents","required":true,"wireName":"unit_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    ...
    schemaField({"name":"components","required":false,"wireName":"components"}, SHARED_FIELD_DEFS.FIELD_104),
    schemaField({"name":"notes","required":false,"wireName":"notes"}, SHARED_FIELD_DEFS.FIELD_1),
    ...
    schemaField({"name":"payment_confirmed_by_label","required":false,"wireName":"payment_confirmed_by_label"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"payment_reference","required":false,"wireName":"payment_reference"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"total_amount_cents","required":false,"wireName":"total_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"due_amount_cents","required":false,"wireName":"due_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"created_at","required":false,"wireName":"created_at"}, SHARED_FIELD_DEFS.FIELD_5),
    schemaField({"name":"updated_at","required":false,"wireName":"updated_at"}, SHARED_FIELD_DEFS.FIELD_5),
    ...
    schemaField({"name":"updated_at","required":false,"wireName":"updated_at"}, SHARED_FIELD_DEFS.FIELD_5),
    schemaField({"name":"assigned_keycloak_user_id","required":false,"wireName":"assigned_keycloak_user_id"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"last_activity","required":false,"wireName":"last_activity"}, SHARED_FIELD_DEFS.FIELD_105)
        ]
      };
    ...
    schemaField({"name":"title","required":false,"wireName":"title"}, SHARED_FIELD_DEFS.FIELD_1)
      ...
      export const TRAVEL_PLAN_DESTINATION_SCOPE_ENTRY_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"destination","required":true,"wireName":"destination"}, SHARED_FIELD_DEFS.FIELD_2),
    schemaField({"name":"areas","required":false,"wireName":"areas"}, SHARED_FIELD_DEFS.FIELD_115)
        ]
      };
    ...
    schemaField({"name":"amount_cents","required":true,"wireName":"amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"currency","required":true,"wireName":"currency"}, SHARED_FIELD_DEFS.FIELD_19),
    schemaField({"name":"line_net_amount_cents","required":false,"wireName":"line_net_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"line_tax_amount_cents","required":false,"wireName":"line_tax_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"line_gross_amount_cents","required":false,"wireName":"line_gross_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103)
        ]
      };
    ...
    schemaField({"name":"subtotal_net_amount_cents","required":true,"wireName":"subtotal_net_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"total_tax_amount_cents","required":true,"wireName":"total_tax_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"grand_total_amount_cents","required":true,"wireName":"grand_total_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    ...
    schemaField({"name":"additional_items","required":false,"wireName":"additional_items"}, SHARED_FIELD_DEFS.FIELD_67)
      ...
      export const TRAVEL_PLAN_DESTINATION_AREA_SELECTION_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"area_id","required":true,"wireName":"area_id"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"places","required":false,"wireName":"places"}, SHARED_FIELD_DEFS.FIELD_123)
        ]
      };
    ...
    schemaField({"name":"kind","required":true,"wireName":"kind"}, SHARED_FIELD_DEFS.FIELD_102),
    schemaField({"name":"title","required":false,"wireName":"title"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"details","required":false,"wireName":"details"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"image_subtitle","required":false,"wireName":"image_subtitle"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"image_subtitle_i18n","required":false,"wireName":"image_subtitle_i18n"}, SHARED_FIELD_DEFS.FIELD_82),
    schemaField({"name":"location","required":false,"wireName":"location"}, SHARED_FIELD_DEFS.FIELD_1),
    ...
    schemaField({"name":"copied_from","required":false,"wireName":"copied_from"}, SHARED_FIELD_DEFS.FIELD_126)
        ]
      };
      ...
      export const BOOKING_OFFER_TAX_BUCKET_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"tax_rate_basis_points","required":true,"wireName":"tax_rate_basis_points"}, SHARED_FIELD_DEFS.FIELD_18),
    schemaField({"name":"net_amount_cents","required":true,"wireName":"net_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"tax_amount_cents","required":true,"wireName":"tax_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"gross_amount_cents","required":true,"wireName":"gross_amount_cents"}, SHARED_FIELD_DEFS.FIELD_103),
    schemaField({"name":"items_count","required":true,"wireName":"items_count"}, SHARED_FIELD_DEFS.FIELD_18)
      ...
      export const BOOKING_OFFER_PAYMENT_TERM_LINE_SCHEMA = {
        ...
        fields: [
    schemaField({"name":"id","required":true,"wireName":"id"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"kind","required":true,"wireName":"kind"}, SHARED_FIELD_DEFS.FIELD_127),
    schemaField({"name":"label","required":true,"wireName":"label"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"sequence","required":true,"wireName":"sequence"}, SHARED_FIELD_DEFS.FIELD_18),
    schemaField({"name":"amount_spec","required":true,"wireName":"amount_spec"}, SHARED_FIELD_DEFS.FIELD_128),
    schemaField({"name":"due_rule","required":true,"wireName":"due_rule"}, SHARED_FIELD_DEFS.FIELD_129)
        ]
      };
    ...
    schemaField({"name":"caption_i18n","required":false,"wireName":"caption_i18n"}, SHARED_FIELD_DEFS.FIELD_82),
    schemaField({"name":"alt_text","required":false,"wireName":"alt_text"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"alt_text_i18n","required":false,"wireName":"alt_text_i18n"}, SHARED_FIELD_DEFS.FIELD_82),
    schemaField({"name":"sort_order","required":true,"wireName":"sort_order"}, SHARED_FIELD_DEFS.FIELD_18),
    ...
    schemaField({"name":"source_attribution","required":false,"wireName":"source_attribution"}, SHARED_FIELD_DEFS.FIELD_131),
    schemaField({"name":"focal_point","required":false,"wireName":"focal_point"}, SHARED_FIELD_DEFS.FIELD_132),
    schemaField({"name":"created_at","required":false,"wireName":"created_at"}, SHARED_FIELD_DEFS.FIELD_5)
        ]
      };
