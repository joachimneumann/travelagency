...
export const GENERATED_OFFER_CATEGORIES = Object.freeze([
  ...
  "OTHER"
    ...
    schemaField({"name":"atpStaffName","required":false,"wireName":"atpStaffName"}, SHARED_FIELD_DEFS.FIELD_1),
    ...
    schemaField({"name":"notes","required":false,"wireName":"notes"}, SHARED_FIELD_DEFS.FIELD_1),
    schemaField({"name":"pricing","required":true,"wireName":"pricing"}, SHARED_FIELD_DEFS.FIELD_15),
    schemaField({"name":"offer","required":true,"wireName":"offer"}, SHARED_FIELD_DEFS.FIELD_16),
    schemaField({"name":"source","required":false,"wireName":"source"}, SHARED_FIELD_DEFS.FIELD_17),
    schemaField({"name":"createdAt","required":true,"wireName":"createdAt"}, SHARED_FIELD_DEFS.FIELD_5),
