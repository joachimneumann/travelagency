...
export const GENERATED_OFFER_CUSTOMER_CONFIRMATION_FLOW_MODE_VALUES = enumValuesFor("GeneratedOfferCustomerConfirmationFlowMode");
export const GENERATED_OFFER_CUSTOMER_CONFIRMATION_FLOW_STATUS_VALUES = enumValuesFor("GeneratedOfferCustomerConfirmationFlowStatus");
