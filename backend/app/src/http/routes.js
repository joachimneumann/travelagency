export const CONTRACT_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "GET", path: "/api/v1/travel-plan-segments/search", handlerKey: "handleSearchTravelPlanSegments" },
  { method: "POST", path: "/api/v1/bookings/{booking_id}/travel-plan/days/{day_id}/segments/import", handlerKey: "handleImportTravelPlanSegment" },
  { method: "POST", path: "/api/v1/bookings/{booking_id}/travel-plan/days/{day_id}/segments/{segment_id}/images", handlerKey: "handleUploadTravelPlanSegmentImage" },
  { method: "DELETE", path: "/api/v1/bookings/{booking_id}/travel-plan/days/{day_id}/segments/{segment_id}/images/{image_id}", handlerKey: "handleDeleteTravelPlanSegmentImage" },
  { method: "PATCH", path: "/api/v1/bookings/{booking_id}/travel-plan/days/{day_id}/segments/{segment_id}/images/order", handlerKey: "handleReorderTravelPlanSegmentImages" },
