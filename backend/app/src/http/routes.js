...
const OPERATIONAL_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "GET", pattern: /^\/api\/v1\/tour-variants$/, handlerKey: "handleListTourVariants" },
  { method: "GET", pattern: /^\/api\/v1\/tour-variants\/source-days$/, handlerKey: "handleListTourVariantSourceDays" },
  { method: "POST", pattern: /^\/api\/v1\/tour-variants\/publish$/, handlerKey: "handlePublishTourVariants" },
  { method: "POST", pattern: /^\/api\/v1\/tour-variants$/, handlerKey: "handleCreateTourVariant" },
  { method: "GET", pattern: /^\/api\/v1\/tour-variants\/([^/]+)$/, handlerKey: "handleGetTourVariant" },
  { method: "PATCH", pattern: /^\/api\/v1\/tour-variants\/([^/]+)$/, handlerKey: "handlePatchTourVariant" },
  { method: "DELETE", pattern: /^\/api\/v1\/tour-variants\/([^/]+)$/, handlerKey: "handleDeleteTourVariant" },
