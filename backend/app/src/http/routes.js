export const CONTRACT_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "GET", path: "/api/v1/travel-plan-templates", handlerKey: "handleListTravelPlanTemplates" },
  { method: "POST", path: "/api/v1/travel-plan-templates", handlerKey: "handleCreateTravelPlanTemplate" },
  { method: "GET", path: "/api/v1/travel-plan-templates/{template_id}", handlerKey: "handleGetTravelPlanTemplate" },
  { method: "PATCH", path: "/api/v1/travel-plan-templates/{template_id}", handlerKey: "handlePatchTravelPlanTemplate" },
  { method: "DELETE", path: "/api/v1/travel-plan-templates/{template_id}", handlerKey: "handleDeleteTravelPlanTemplate" },
  { method: "POST", path: "/api/v1/bookings/{booking_id}/travel-plan/templates/{template_id}/apply", handlerKey: "handleApplyTravelPlanTemplate" },
  ...
  { method: "POST", path: "/api/v1/bookings/{booking_id}/booking-confirmation/pdfs", handlerKey: "handlePostBookingConfirmationPdf" },
