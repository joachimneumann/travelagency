export const CONTRACT_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "POST", path: "/api/v1/tour-variants/publish", handlerKey: "handlePublishTourVariants" },
...
const OPERATIONAL_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "POST", pattern: /^\/api\/v1\/tours\/publish$/, handlerKey: "handlePublishTours" },
