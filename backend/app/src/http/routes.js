export const CONTRACT_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "DELETE", path: "/api/v1/destination-scope/destinations/{destination}", handlerKey: "handleDeleteDestinationScopeDestination" },
  { method: "POST", path: "/api/v1/destination-scope/regions", handlerKey: "handleCreateDestinationRegion" },
  { method: "DELETE", path: "/api/v1/destination-scope/regions/{region_id}", handlerKey: "handleDeleteDestinationRegion" },
  { method: "POST", path: "/api/v1/destination-scope/places", handlerKey: "handleCreateDestinationPlace" },
  { method: "DELETE", path: "/api/v1/destination-scope/places/{place_id}", handlerKey: "handleDeleteDestinationPlace" },
  { method: "GET", path: "/api/v1/tours", handlerKey: "handleListTours" },
  { method: "GET", path: "/api/v1/tour-variants", handlerKey: "handleListTourVariants" },
  { method: "GET", path: "/api/v1/tour-variants/source-days", handlerKey: "handleListTourVariantSourceDays" },
  { method: "POST", path: "/api/v1/tour-variants", handlerKey: "handleCreateTourVariant" },
  { method: "GET", path: "/api/v1/tour-variants/{tour_variant_id}", handlerKey: "handleGetTourVariant" },
  { method: "PATCH", path: "/api/v1/tour-variants/{tour_variant_id}", handlerKey: "handlePatchTourVariant" },
  { method: "DELETE", path: "/api/v1/tour-variants/{tour_variant_id}", handlerKey: "handleDeleteTourVariant" },
...
const OPERATIONAL_ROUTE_DEFINITIONS = Object.freeze([
  ...
  { method: "GET", pattern: /^\/api\/v1\/static-translations\/policy$/, handlerKey: "handleGetStaticTranslationPolicy" },
  { method: "PATCH", pattern: /^\/api\/v1\/static-translations\/policy$/, handlerKey: "handlePatchStaticTranslationPolicy" },
  ...
  { method: "GET", pattern: /^\/api\/v1\/tour-variants\/([^/]+)\/one-pager\.pdf$/, handlerKey: "handleGetTourVariantOnePagerPdf" },
  { method: "GET", pattern: /^\/api\/v1\/tour-variants\/([^/]+)\/travel-plan\.pdf$/, handlerKey: "handleGetTourVariantTravelPlanPdf" },
  { method: "GET", pattern: /^\/public\/v1\/tours\/([^/]+)\/one-pager\.pdf$/, handlerKey: "handleGetPublicTourOnePagerPdf" },
  { method: "GET", pattern: /^\/public\/v1\/tours\/([^/]+)\/travel-plan\.pdf$/, handlerKey: "handleGetPublicTourTravelPlanPdf" },
  { method: "POST", pattern: /^\/public\/v1\/tours\/([^/]+)\/one-pager-preview$/, handlerKey: "handlePostPublicTourOnePagerPreview" },
  { method: "POST", pattern: /^\/public\/v1\/tours\/([^/]+)\/travel-plan-preview$/, handlerKey: "handlePostPublicTourTravelPlanPreview" },
  { method: "GET", pattern: /^\/public\/v1\/tour-preview\/([^/]+)\.pdf$/, handlerKey: "handleGetPublicTourOnePagerPreviewPdf" },
  { method: "GET", pattern: /^\/public\/v1\/tour-preview\/([^/]+)\/travel-plan\.pdf$/, handlerKey: "handleGetPublicTourTravelPlanPreviewPdf" },
