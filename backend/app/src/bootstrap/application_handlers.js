...
import { createPublicSiteDeploymentStatusHandlers } from "../http/handlers/public_site_deployment_status.js";
...
export function createApplicationRoutes({
  ...
  const bookingHandlers = createBookingHandlers({
    ...
    filterAndSortBookings: bookingViewHelpers.filterAndSortBookings,
  ...
  const tourHandlers = createTourHandlers({
    ...
    execFile: runtime.execFile,
    TEMP_UPLOAD_DIR: runtime.paths.tempUploadDir,
    PUBLIC_TOUR_PDF_CACHE_DIR: runtime.paths.publicTourPdfCacheDir,
    PUBLIC_TOUR_ONE_PAGER_PDF_CACHE_DIR: runtime.paths.publicTourOnePagerPdfCacheDir,
    PUBLIC_TOUR_TRAVEL_PLAN_PDF_CACHE_DIR: runtime.paths.publicTourTravelPlanPdfCacheDir,
    PUBLIC_TOUR_ONE_PAGER_PDF_PREVIEW_DIR: runtime.paths.publicTourOnePagerPdfPreviewDir,
    PUBLIC_TOUR_TRAVEL_PLAN_PDF_PREVIEW_DIR: runtime.paths.publicTourTravelPlanPdfPreviewDir,
    TOURS_DIR: runtime.paths.toursDir,
    TRANSLATIONS_SNAPSHOT_DIR: runtime.paths.translationsSnapshotDir,
    TRANSLATION_PHRASE_OVERRIDES_PATH: runtime.paths.translationPhraseOverridesPath,
    BOOKING_IMAGES_DIR: runtime.paths.bookingImagesDir,
    writeFile,
    rm
  });
  ...
  return buildApiRoutes({
    ...
    handlers: {
      ...
      ...publicSiteDeploymentStatusHandlers,
      ...tourMatrixHandlers,
      ...tourVariantHandlers,
      ...tourHandlers
    }
