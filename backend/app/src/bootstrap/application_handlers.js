...
export function createApplicationRoutes({
  ...
  const bookingHandlers = createBookingHandlers({
    ...
    persistBookingConfirmationPdfArtifact: bookingConfirmationPdfArtifacts.persistBookingConfirmationPdfArtifact,
    resolveBookingConfirmationPdfArtifact: bookingConfirmationPdfArtifacts.resolveBookingConfirmationPdfArtifact,
    deleteBookingConfirmationPdfArtifact: bookingConfirmationPdfArtifacts.deleteBookingConfirmationPdfArtifact,
