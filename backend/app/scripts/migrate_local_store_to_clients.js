...
function computeBookingHash(booking) {
  return hashPayload({
    ...
    web_form_travel_duration: booking?.web_form_travel_duration || null,
    web_form_travel_duration_days_min: booking?.web_form_travel_duration_days_min ?? null,
    web_form_travel_duration_days_max: booking?.web_form_travel_duration_days_max ?? null,
...
async function main() {
  ...
  const normalizedBookings = bookings.map((booking) => {
    ...
    const normalized = {
      ...
      number_of_travelers: booking.number_of_travelers ?? null,
      web_form_travel_duration: optional(booking.web_form_travel_duration),
      web_form_travel_duration_days_min: booking.web_form_travel_duration_days_min ?? null,
      web_form_travel_duration_days_max: booking.web_form_travel_duration_days_max ?? null,
