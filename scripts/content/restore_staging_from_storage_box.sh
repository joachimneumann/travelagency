...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/content/restore_staging_from_storage_box.sh --snapshot <timestamp> [--yes]
...
Example:
  ...
  ./scripts/content/restore_staging_from_storage_box.sh --snapshot 2026-04-05T18-43-31Z --yes
EOF
}
