...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/update_production.sh [backend|keycloak|all]...

Examples:
  ./scripts/update_production.sh backend
  ./scripts/update_production.sh keycloak
  ./scripts/update_production.sh all
EOF
}
