	...
	types: [
		...
		},
		{
			...
			fields: [
				...
				{name: "caption_i18n", kind: "map", typeName: "string", required: false},
				{name: "alt_text", kind: "scalar", typeName: "string", required: false},
				{name: "alt_text_i18n", kind: "map", typeName: "string", required: false},
				...
				{name: "include_in_travel_tour_card", kind: "scalar", typeName: "bool", required: false},
		...
		},
		{
			...
			domain:     "booking"
			module:     "database"
			sourceType: "database.#MarketingTourTravelPlanDay"
			fields: [
				{name: "id", kind: "scalar", typeName: "Identifier", required: true},
				...
				{name: "notes_i18n", kind: "map", typeName: "string", required: false},
			]
		},
		{
		...
		},
		{
			...
			domain:     "booking"
			module:     "database"
			sourceType: "database.#MarketingTourTravelPlanBoundaryService"
			fields: [
				{name: "id", kind: "scalar", typeName: "Identifier", required: true},
		...
		},
		{
			...
			domain:     "booking"
			module:     "database"
			sourceType: "database.#MarketingTourTravelPlanBoundaryLogistics"
			fields: [
				{name: "arrival", kind: "entity", typeName: "MarketingTourTravelPlanBoundaryService", required: false},
				{name: "departure", kind: "entity", typeName: "MarketingTourTravelPlanBoundaryService", required: false},
			]
		},
		{
			...
			domain:     "booking"
			module:     "database"
			sourceType: "database.#BookingTravelPlanBoundaryService"
			fields: [
				{name: "id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "boundary_kind", kind: "enum", typeName: "TravelPlanBoundaryKind", required: true},
				{name: "enabled", kind: "scalar", typeName: "bool", required: false},
		...
		},
		{
			...
			domain:     "booking"
			module:     "database"
			sourceType: "database.#BookingTravelPlanBoundaryLogistics"
			fields: [
				{name: "arrival", kind: "entity", typeName: "BookingTravelPlanBoundaryService", required: false},
				{name: "departure", kind: "entity", typeName: "BookingTravelPlanBoundaryService", required: false},
			]
		},
		{
		...
		},
		{
			...
			domain:     "booking"
				...
				{name: "boundary_logistics", kind: "entity", typeName: "MarketingTourTravelPlanBoundaryLogistics", required: false},
				{name: "days", kind: "entity", typeName: "MarketingTourTravelPlanDay", required: false, isArray: true},
			]
		},
		{
		...
		},
		{
			...
			domain:     "booking"
				...
				{name: "one_pager_hero_image_id", kind: "scalar", typeName: "Identifier", required: false},
				{name: "one_pager_image_ids", kind: "scalar", typeName: "Identifier", required: false, isArray: true},
				{name: "boundary_logistics", kind: "entity", typeName: "BookingTravelPlanBoundaryLogistics", required: false},
		...
		},
		{
			...
			},
			{
				...
				fields: [
					...
					{name: "source_day", kind: "entity", typeName: "MarketingTourTravelPlanDay", required: false},
				]
			},
			{
			...
			fields: [
				{name: "source_tour_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "source_tour_title", kind: "scalar", typeName: "string", required: false},
				{name: "source_tour_code", kind: "scalar", typeName: "string", required: false},
				{name: "day_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "day_number", kind: "scalar", typeName: "int", required: false},
				{name: "title", kind: "scalar", typeName: "string", required: false},
				{name: "notes", kind: "scalar", typeName: "string", required: false},
				{name: "thumbnail_url", kind: "scalar", typeName: "string", required: false},
		...
		},
		{
			...
			domain:     "api"
			module:     "api"
			sourceType: "api.#TourTravelPlanDaySearchResponse"
			fields: [
				{name: "items", kind: "transport", typeName: "TourTravelPlanDaySearchResult", required: true, isArray: true},
				{name: "total", kind: "scalar", typeName: "int", required: true},
			]
		},
		{
			...
			domain:     "api"
			module:     "api"
			sourceType: "api.#TourTravelPlanServiceSearchResult"
			fields: [
				{name: "source_tour_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "source_tour_title", kind: "scalar", typeName: "string", required: false},
				{name: "source_tour_code", kind: "scalar", typeName: "string", required: false},
		...
		},
		{
			...
			domain:     "api"
			module:     "api"
			sourceType: "api.#TourTravelPlanServiceSearchResponse"
			fields: [
				{name: "items", kind: "transport", typeName: "TourTravelPlanServiceSearchResult", required: true, isArray: true},
				{name: "total", kind: "scalar", typeName: "int", required: true},
			]
		},
		{
		...
		},
		{
			...
			domain:     "api"
			module:     "api"
			sourceType: "api.#TourTravelPlanDayImportRequest"
			fields: [
				{name: "expected_updated_at", kind: "scalar", typeName: "Timestamp", required: false},
				{name: "source_tour_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "source_day_id", kind: "scalar", typeName: "Identifier", required: true},
		...
		},
		{
			...
			domain:     "api"
			module:     "api"
			sourceType: "api.#TourTravelPlanServiceImportRequest"
			fields: [
				{name: "expected_updated_at", kind: "scalar", typeName: "Timestamp", required: false},
				{name: "source_tour_id", kind: "scalar", typeName: "Identifier", required: true},
		...
		},
		{
			...
			fields: [
				...
				{name: "source_tour_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "source_day_id", kind: "scalar", typeName: "Identifier", required: true},
				{name: "target_travel_plan", kind: "entity", typeName: "BookingTravelPlan", required: false},
				{name: "include_images", kind: "scalar", typeName: "bool", required: true},
				{name: "include_customer_visible_images_only", kind: "scalar", typeName: "bool", required: true},
				{name: "include_notes", kind: "scalar", typeName: "bool", required: true},
				{name: "actor", kind: "scalar", typeName: "string", required: false},
