...
export const GENERATED_OFFER_BOOKING_CONFIRMATION_ROUTE_MODE_OPTIONS = enumOptionsFor("GeneratedOfferBookingConfirmationRouteMode");
export const GENERATED_OFFER_BOOKING_CONFIRMATION_ROUTE_MODE_CATALOG = enumValuesFor("GeneratedOfferBookingConfirmationRouteMode");
export const GENERATED_OFFER_BOOKING_CONFIRMATION_ROUTE_STATUS_OPTIONS = enumOptionsFor("GeneratedOfferBookingConfirmationRouteStatus");
export const GENERATED_OFFER_BOOKING_CONFIRMATION_ROUTE_STATUS_CATALOG = enumValuesFor("GeneratedOfferBookingConfirmationRouteStatus");
