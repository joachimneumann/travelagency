...
export const TRAVEL_PLAN_ITEM_KIND_OPTIONS = enumOptionsFor("TravelPlanItemKind");
export const TRAVEL_PLAN_ITEM_KIND_CATALOG = enumValuesFor("TravelPlanItemKind");
