import { bookingChatRequest } from "../../Generated/API/generated_APIRequestFactory.js?v=f09b901159f7";
import { escapeHtml, normalizeText } from "../shared/api.js?v=f09b901159f7";
...
} from "./segment_headers.js?v=f09b901159f7";
